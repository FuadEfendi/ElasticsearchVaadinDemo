                ...
                if (exampleItem.getClass().isAssignableFrom(ExampleCtgr.class)) {
                    ...
                    if (fragments != null) {
                        ...
                        for (int fragmentNum = 0; fragmentNum < fragments.size(); fragmentNum++) {
                            ...
                            String srcurl = "https://github.com/FuadEfendi/ElasticsearchVaadinDemo/blob/master/src/main/java" + fragment.getSrcName();
                    ...
                    if (example.getCssFragments() != null && example.getCssFragments().size() > 0) {
                        ...
                        String srcurl = "https://github.com/FuadEfendi/ElasticsearchVaadinDemo/blob/master/WebContent/VAADIN/themes/elasticsearch-vaadin-demo/elasticsearch-vaadin-demo.scss";
